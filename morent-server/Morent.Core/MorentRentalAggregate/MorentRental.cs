...
public class MorentRental : EntityBase<int>, IAggregateRoot
{
  ...
  private MorentRental(Guid userId, Guid carId, DateRange rentalPeriod,
  ...
  public static Result<MorentRental> Create(Guid userId, Guid carId, DateRange rentalPeriod,
                                    Location pickupLocation, Location dropoffLocation, Money totalCost)
  {
    ...
    var rental = new MorentRental(userId, carId, rentalPeriod, pickupLocation, dropoffLocation, totalCost);
