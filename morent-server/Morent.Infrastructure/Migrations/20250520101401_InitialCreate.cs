        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LocationAddress = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LogoImageId = table.Column<Guid>(type: "TEXT", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PaymentMethods_Images_LogoImageId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Payments_PaymentMethods_ProviderId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PickupLocationAddress = table.Column<string>(type: "TEXT", nullable: true),
                    PickupLocationCity = table.Column<string>(type: "TEXT", nullable: true),
                    PickupLocationCountry = table.Column<string>(type: "TEXT", nullable: true),
                    PickupLocationLongitude = table.Column<double>(type: "REAL", nullable: false),
                    PickupLocationLatitude = table.Column<double>(type: "REAL", nullable: false),
                    DropoffLocationAddress = table.Column<string>(type: "TEXT", nullable: true),
                    DropoffLocationCity = table.Column<string>(type: "TEXT", nullable: true),
                    DropoffLocationCountry = table.Column<string>(type: "TEXT", nullable: true),
                    DropoffLocationLongitude = table.Column<double>(type: "REAL", nullable: false),
                    DropoffLocationLatitude = table.Column<double>(type: "REAL", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PaymentMethods_LogoImageId",
